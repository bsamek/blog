...
~~Here's my list.~~ I keep a continually updated list of benchmarks at [samek.fyi/benchmarks](https://samek.fyi/benchmarks/). I deleted the old list that used to live in this post so that I could link to the updated one instead.
